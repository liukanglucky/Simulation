<div class="tab-pane" id="tab3B">
              ...
              <tbody>
                <tr>
                  ...
                  <td><select name="type2" style="width:75px; height:20px">
                      <option value="1">001</option><option value="2">002</option>
                    </select>
                  </td>
                  <td>输出频率范围</td>
                  <td><input name="fre1" style="width:60px;" type="text" id="fre1_1"></td>
            ...
            <br><br>
            <div class="span2">线谱频率1-20</div>
            <div class="span8">
              <table border="0" cellpadding="1" cellspacing="1" style="width: 100%;">
                <tbody>
                  <tr>
                    <td><input name="xp1" style="width:40px;" type="text"></td>
                    <td><input name="xp1" style="width:40px;" type="text"></td>
                    <td><input name="xp1" style="width:40px;" type="text"></td>
                    <td><input name="xp1" style="width:40px;" type="text"></td>
                    <td><input name="xp1" style="width:40px;" type="text"></td>
            ...
            <div class="span2">线谱强度1-20</div>
            <div class="span8">
              <table border="0" cellpadding="1" cellspacing="1" style="width: 100%;">
                <tbody>
                  <tr>
                    <td><input name="xp2" style="width:40px;" type="text"></td>
                    <td><input name="xp2" style="width:40px;" type="text"></td>
                    <td><input name="xp2" style="width:40px;" type="text"></td>
                    <td><input name="xp2" style="width:40px;" type="text"></td>
                    <td><input name="xp2" style="width:40px;" type="text"></td>
            ...
            <div class="span2">调制深度1-20</div>
            <div class="span8">
              <table border="0" cellpadding="1" cellspacing="1" style="width: 100%;">
                <tbody>
                  <tr>
                    <td><input name="de" style="width:40px;" type="text"></td>
                    <td><input name="de" style="width:40px;" type="text"></td>
                    <td><input name="de" style="width:40px;" type="text"></td>
                    <td><input name="de" style="width:40px;" type="text"></td>
                    <td><input name="de" style="width:40px;" type="text"></td>
              ...
              <input type="button" class="btn btn-warning" value="保存数据"
							onClick="autoGetVal('tab3B','3B','3B');">
						<input type="button" class="btn btn-success" value="开始仿真"
							onClick="run('tab3B','3B');">
            </div>
          </div>